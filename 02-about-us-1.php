    ...
    <div class="container"> 
      ...
      <nav class="webimenu"> 
        ...
        <ul class="ownmenu">
          ...
          <li class="active"><a href="02-about-us-1.php">About us </a>
            <!--<ul class="dropdown animated-3s fadeIn">
  ...
  <div class="content fix-nav-space"> 
    ...
    <div class="about-us"> 
      ...
      <div class="time-line-sec time-line-2">
        <div class="container">
          <h2 class="text-center">Hi, we are <span>Goyal City Hospital</span> We care about
            your heath!</h2>
            
              <h4 class="text-center" style="margin-top: 80px;line-height: 35px;">Goyal City Hospital is the “State of Art” Hospital situated at NH-2 Trans Yamuna Colony,Firozabad Road Rambagh Agra.It has started its drive to accomplish the aim of endowing high quality health care services to the people of Agra in every aspect.

                Goyal City Hospital is the Corporate Hospital in the city with 45 beds loaded with ultra-modern medical and healthcare facilities.
                
                The Promoters running a Mother , Father and Baby friendly Hospital providing the Best services to the society for more than last 25 years.</h4>
              <!--<p class="text-center">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum sequitur mutationem consuetudium lectorum. </p>
          <!--<div class="row"> 
            ...
            <!--<div class="col-md-12"> 
              ...
              <!--<ul class="time-line">
                ...
                <!--<li class="row">
                  ...
                  <div class="col-xs-9">
                    <h6>Duis autem vel eum iriure dolor </h6>
                    <p>Eodem modo typi, qui nunc nobis videntur parum clariqui sequitur. Ienatibus et magnis dis parturient </p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="doctor-in">
            ...
            <div class="personal-info">
              ...
              <ul>
                ...
                <li class="col-sm-8">janebutler@Goyal City Hospitalclinic.com</li>
              </ul>
              <ul>
