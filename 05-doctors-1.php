    ...
    <div class="container"> 
      ...
      <nav class="webimenu"> 
        ...
        <ul class="ownmenu">
          ...
          <li class="active"><a href="05-doctors-1.php">Doctors</a> 
            <!--======= MEGA MENU =========-->
    ...
    <section id="team">
      <div class="container"> 
        ...
        <div class="tittle tittle-2">
          <h3>Our Team Of Highly Skilled </h3>
          <hr>
        ...
        <div class="row">
          <div class="col-md-6"> 
            ...
            <ul class="row">
              ...
              <!--======= TEAM =========-->
              <li class="col-sm-6">
                <div class="team"> <img class="img-responsive" src="images/team-1.jpg" alt="">
                  <div class="team-over"> 
                    <!--======= SOCIAL ICON =========-->
              ...
              <!--======= TEAM =========-->
              <li class="col-sm-6">
                <div class="team"> <img class="img-responsive" src="images/team-2.jpg" alt="">
                  <div class="team-over"> 
                    <!--======= SOCIAL ICON =========-->
                    <ul class="social_icons animated-6s fadeInUp">
                      <li class="facebook"><a href="#."><i class="fa fa-facebook"></i></a></li>
          ...
          <div class="col-md-6"> 
            ...
            <ul class="row">
              ...
              <!--======= TEAM =========-->
              <li class="col-sm-6">
                <div class="team"> <img class="img-responsive" src="images/team-3.jpg" alt="">
                  <div class="team-over"> 
                    <!--======= SOCIAL ICON =========-->
                    <ul class="social_icons animated-6s fadeInUp">
                      <li class="facebook"><a href="#."><i class="fa fa-facebook"></i></a></li>
              ...
              <!--======= TEAM =========-->
              <li class="col-sm-6">
                <div class="team"> <img class="img-responsive" src="images/team-4.jpg" alt="">
                  <div class="team-over"> 
                    <!--======= SOCIAL ICON =========-->
                    <ul class="social_icons animated-6s fadeInUp">
                      <li class="facebook"><a href="#."><i class="fa fa-facebook"></i></a></li>
      ...
      <!--======= DOCTOR LIST =========-->
      <div class="doctor-list no-padding">
        <div class="container"> 
