        ...
        <ul class="row">
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-stethoscope"></i>
              <h6>Individual and corporate Health Check-up</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Nunc finibus sit amet gravida. </p>
            </div>
          </li>
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-wheelchair"></i>
              <h6>Emergency & Causality with Triage Facility</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Nunc finibus sit amet gravida. </p>
            </div>
          </li>
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-heartbeat"></i>
              <h6>24 Hours Ambulance Facility</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Nunc finibus sit amet gravida. </p>
            </div>
          </li>
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-user-md"></i>
              <h6>Nursing on Call (Home Nursing)</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus.  Nunc finibus sit amet gravida. </p>
            </div>
          </li>
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-wheelchair"></i>
              <h6>24 Hours In House Medical Store</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Nunc finibus sit amet gravida. </p>
            </div>
          </li>
          ...
          <li class="col-sm-4">
            <div class="slide sec-ser"> <i class="fa fa-heartbeat"></i>
              <h6>General Ward and Private Room Available</h6>
              <p>Cum sociis natoque penatibus et magnis dis parturient montesmus. Nunc finibus sit amet gravida. </p>
            </div>
          </li>
        </ul>
